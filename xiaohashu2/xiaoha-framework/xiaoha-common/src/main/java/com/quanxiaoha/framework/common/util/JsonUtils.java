...
public class JsonUtils {
    ...
    static {
        OBJECT_MAPPER.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);//遇到未知属性，不报错
        OBJECT_MAPPER.configure(SerializationFeature.FAIL_ON_EMPTY_BEANS, false);//空对象可以转json
    ...
    public static String toJsonString(Object obj) {
       return OBJECT_MAPPER.writeValueAsString(obj);//writeValueAsString该方法是将Java对象转为json数据格式
    }
    ...
    */
    ...
    public static <T> T parseObject(String jsonStr,Class<T> clazz){
      ...
      //使用Jackson的readValue将json字符串转为Java对象
